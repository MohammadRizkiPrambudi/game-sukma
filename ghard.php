...
if(isset($_POST["simpan"])){
  ...
  if ($hitung  > 0) {
    ...
    $update = mysqli_query($koneksi, "UPDATE tbl_tanggapan SET tanggapan_hard = '$tanggapan' WHERE id_user='$user'");
    if($update){
      echo "
      <script>
    ...
    $simpan = mysqli_query($koneksi, "INSERT INTO tbl_tanggapan(id_tanggapan, id_user, tanggapan_hard) VALUES('','$user','$tanggapan')");
    if($simpan){
      echo "
      <script>
      alert('Terima kasih atas tanggapannya!!');
...
<body style="background-image: url(assets/dist/img/bg3.jpg); background-size: cover">
  ...
  <h2 class="mt-1">Level 3</h2>

  <div class="button-group mt-2">
    <button type="button" class="mulai hard" onclick="mulai(200, 800)" >
