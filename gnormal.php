...
if(isset($_POST["simpan"])){
  ...
  if ($hitung  > 0) {
    ...
    $update = mysqli_query($koneksi, "UPDATE tbl_tanggapan SET tanggapan_normal = '$tanggapan' WHERE id_user='$user'");
    if($update){
      echo "
      <script>
      alert('Terima kasih atas tanggapannya!!');
      document.location='ghard.php';
      </script>
      ";
    }

  }else{
    $simpan = mysqli_query($koneksi, "INSERT INTO tbl_tanggapan(id_tanggapan, id_user, tanggapan_normal) VALUES('','$user','$tanggapan')");
    if($simpan){
      echo "
      <script>
      alert('Terima kasih atas tanggapannya!!');
...
<body style="background-image: url(assets/dist/img/bg3.jpg); background-size: cover">
  ...
  <h1 class="mt-2">Game Athena Versi 1.0</h1>
  <h2 class="mt-1">Level 2</h2>

  <div class="button-group mt-2">
    <button type="button" class="mulai normal" onclick="mulai(500, 1100)" >
